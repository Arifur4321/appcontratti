                ...
                success: function(response) {
                    ...
                    response.variableIDs.forEach(function(variableID, index) {
                        ...
                        if ($row.length) {
                            ...
                            // Set the mandatory checkbox based on the response, but leave it enabled
                            const isMandatory = response.mandatoryStatuses[index] === "true";
                            $row.find('.mandatoryvariablecheckbox')
