            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="/Contract-List" key="Contract-List" class="waves-effect">
                        <i class="bx bx-file"></i>
                        <span><?php echo app('translator')->get('translation.Contract-List'); ?></span>
                    </a>
                </li>
                <li>
                    <a href="/Product-List" key="Product-List" class="waves-effect">
                        <i class="bx bx-box"></i>
                        <span><?php echo app('translator')->get('translation.Product-List'); ?></span>
                    </a>
                </li>
                <li>
                    <a href="/Variable-List" key="Variable-List" class="waves-effect">
                        <i class="bx bx-cog"></i>
                        <span><?php echo app('translator')->get('translation.Variable-List'); ?></span>
                    </a>
                </li>
                <li>
                    <a href="/Price-List" key="Price-List" class="waves-effect">
                        <i class="bx bx-dollar-circle"></i>
                        <span><?php echo app('translator')->get('translation.Price-List'); ?></span>
                    </a>
                </li>
                <li>
                    <a href="/Contract-History" key="Contract-History" class="waves-effect">
                        <i class="bx bx-history"></i>
                        <span><?php echo app('translator')->get('translation.Contract-History'); ?></span>
                    </a>
                </li>
                <li>
                    <a href="/Sales-Lists" key="Sales-Lists" class="waves-effect">
                        <i class="bx bx-cart"></i>
                        <span><?php echo app('translator')->get('translation.Sales-Lists'); ?></span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="/AppConnections" key="Sales-Performence" class="waves-effect">
                        ...
                        <span><?php echo app('translator')->get('translation.App-Connection'); ?></span>
                    </a>
                </li>

                <li>
                    <a href="/Email-SMS-Template" key="Email-SMS-Template" class="waves-effect">
                        <i class="bx bx-envelope"></i>
                        <span><?php echo app('translator')->get('translation.Email-SMS-Template'); ?></span>
                    </a>
                </li>
...
<!-- Left Sidebar End -->
<?php /**PATH F:\Giacometti\New-Working-Directory-25-10-2024\appcontratti\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>