        ...
        let table = new DataTable('#ContractList', {
            ...
            language: {
                paginate: {
                    first: '<<',
                    last: '>>',
                    next: '<?php echo app('translator')->get('translation.NEXT'); ?>',
                    previous: '<?php echo app('translator')->get('translation.PREVIOUS'); ?>'
                },
                 lengthMenu: "<?php echo app('translator')->get('translation.SHOW_ENTRIES', ['entries' => '_MENU_']); ?>"
            }
        });
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Giacometti\New-Working-Directory-25-10-2024\appcontratti\resources\views/ContractList.blade.php ENDPATH**/ ?>