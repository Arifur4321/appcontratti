...
//              'company_name' => 'required|string|max:255',
//              'address' => 'required|string',
//              'vat_number' => 'required|string|max:255', // Add validation for vat_number
//          ]);
 
//          Company::create([
//              'company_name' => $request->company_name,
//              'address' => $request->address,
//              'vat_number' => $request->vat_number, // Save vat_number
//          ]);
 
//         // return redirect()->route('register'); // Update this route as necessary
//         return redirect()->route('register')->with('success', 'Company registered successfully.'); 
//     }
//  }
