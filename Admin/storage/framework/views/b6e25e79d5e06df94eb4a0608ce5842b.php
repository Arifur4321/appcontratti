            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="/Price-List" key="Price-List"><?php echo app('translator')->get('translation.Price-List'); ?></a></li>  

                        <!-- <li><a href="/Sales-Details" key="Sales-Details"><?php echo app('translator')->get('translation.Sales-Details'); ?></a></li>   -->

                        <li><a href="/Sales-Lists" key="Sales-Lists"><?php echo app('translator')->get('translation.Sales-Lists'); ?></a></li> 
                        

                        <!-- <li><a href="/Add-New-Price" key="Add-New-Price"><?php echo app('translator')->get('translation.Add-New-Price'); ?></a></li>    -->
            
                        <li><a href="/HeaderAndFooter" key="HeaderAndFooter"><?php echo app('translator')->get('translation.HeaderAndFooter'); ?></a></li>   
...
<!-- Left Sidebar End -->
<?php /**PATH F:\Giacometti\Skote_Html_Laravel_v4.2.1\Laravel\Server-Backup\3-5-24-forPreview-PDF\Admin\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>