    ...
    <div class="col-sm">
        ...
        <div class="row">
            <div class="col-3">
                <div id="minrata">
                    <div class="mb-3">
                        <label for="minrataValue" class="form-label">Min Rata:</label>
                        <input type="number" class="form-control w-100" id="minrataValue" name="minrataValue" value="{{ $priceList->minrata }}">
                    </div>
                </div>
...
<script>
   ...
   document.getElementById('saveButton').addEventListener('click', function() {
    ...
    var minrataValue = document.getElementById('minrataValue').value;

    console.log('Ari today minrataValue  :' ,  minrataValue );
