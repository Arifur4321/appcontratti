    ...
    <div>
        <div class="container-fluid p-0">
            ...
            <form method="POST" action="<?php echo e(route('admin.login.submit')); ?>">
                ...
                <?php if($errors->has('password')): ?>
                    <div class="alert alert-danger mt-2"><?php echo e($errors->first('password')); ?></div>
                <?php endif; ?>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u121027207/domains/appcontratti.it/public_html/resources/views/admin/login.blade.php ENDPATH**/ ?>