...
<!-- App js -->
<script src="<?php echo e(URL::asset('build/js/plugin.js')); ?>"></script><?php /**PATH F:\Giacometti\Skote_Html_Laravel_v4.2.1\Laravel\Server-Backup\3-5-24-forPreview-PDF\Admin\resources\views/layouts/head-css.blade.php ENDPATH**/ ?>