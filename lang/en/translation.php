...
return [
  ...
  "Enable Pending Note" => "Enable/Disable Pending Note :  use \$contract_name\$ and \$product_name\$ to get your Actual details to add note in CRM",
 
  "Enable Signed Note" => "Enable/Disable Signed Note : use \$contract_name\$ and \$product_name\$ to get your Actual details to add note in CRM",

  "Select Pending Tags" => "Select Pending Tags",

  "Select Signed Tags"=> "Select Signed Tags",

  "Email-SMS-Template" => "Email-SMS-Template",

  "special-char" => "(Please Do not use Special Char only for Multiple box)", 
